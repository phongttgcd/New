...
class CartController extends AbstractController
{
    ...
    #[Route('/cart/personal/', name: 'cart_personal')]
    public function personalList(): Response
    {   
        // Call Entity Manager
            $em = $this
            ->getDoctrine()
        ...
        // Call function
        $result = $cartRepo->getPersonalAscending();

        // Return result to View
        return $this->render('cart/personal.html.twig', [
            'cart' => $result
        ]);
    }
}
